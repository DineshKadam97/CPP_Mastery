...
class Derived_2 : public Derived_1
{
    public:
        ...
        {
            this->Base_public_num = 100;    // CTE
            this->Base_protected_num = 110; // CTE
...
void external_function_testing_with_base_object(void)
{
   ...
   d1obj.Derived_1_public_num = 345;
   d1obj.Derived_1_protected_num = 346; // CTE

   d1obj.Base_public_num = 345; // CTE
   d1obj.Base_protected_num = 235; // CTE

   Derived_2 d2obj;
   d2obj.Derived_1_public_num = 234;
   d2obj.Derived_1_protected_num = 24234; // CTE

   d2obj.Base_public_num = 2453; // CTE
